...
class HiddenMarkovModel:
    ...
    def generate_sonnet_emission(self, obs_map_r, syllables_map, n_syllables):
        '''
    ...
    def generate_sonnet_emission_rhyme(self, encoded_start_word, obs_map_r, syllables_map, n_syllables):
        '''
        Generates an emission with n_syllables syllables, assuming that the starting state
        is chosen uniformly at random.
